                    ...
                    <div class="card-body p-0">
                        <div class="row p-5">
                            ...
                            <div class="col-md-6 text-right">
                                ...
                                <p class="text-muted">Due to: {{ date('M d, Y H:i:s', strtotime('+7 hours',strtotime($order->created_at))) }}</p>
                            </div>
                        </div>
                        <hr class="my-5">
                        <div class="row pb-5 p-5">
                            ...
                            <div class="col-md-6 text-right">
                                ...
                                <p class="mb-1"><span class="text-muted">Name: </span> {{ $order->cus_name }} </p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-row-reverse bg-dark text-white p-4">
                            <div class="py-3 px-5 text-right">
                                ...
                                <div class="h2 font-weight-light">${{ number_format($order->total_price) }}</div>
                            </div>
                        </div>
                    </div>
                </div>
