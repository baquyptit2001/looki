            ...
            <div class="tab-pane fade" id="dashboad" role="tabpanel">
              <div class="myaccount-content">
                ...
                <div class="welcome mb-20">
                  <p>
                    Hello, <strong>{{ auth()->user()->display_name }}</strong> (If Not
              ...
              <div class="myaccount-content">
                ...
                <div class="account-details-form">
                    <div class="row">
                              ...
                              <div class="col-12">
                                  <div class="card">
                                      <div class="card-body">
                                          ...
                                          <input type="date" id="input-file-now-custom-2" name="birthday" value="{{ auth()->user()->birthday }}"/>
                                      </div>
                                  </div>
                              </div>
                          </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="statuss" name="gender" value="1" class="custom-control-input" {{ (auth()->user()->gender) ? 'checked':'' }}>
                                            <label class="custom-control-label" for="statuss">Nam</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="status" name="gender" value="0" class="custom-control-input" {{ (auth()->user()->gender) ? '':'checked' }}>
                      ...
                      @if (Session::get('change_pass_success'))
                        <div class="alert alert-success" role="alert">
                          {{Session::get('change_pass_success')}}
                        </div>
                      @endif
                      @if (Session::get('change_pass_not_success'))
                        <div class="alert alert-danger" role="alert">
                          {{Session::get('change_pass_not_success')}}
                        </div>
                      @endif
