                        ...
                        <div class="product-sync-init mb-20">
                            <div class="single-product">
                                <div class="product-thumb">
                                    <img src="<?php echo e(asset('uploads/'.$pro->image)); ?>" alt="product-thumb" />
                                </div>
                            </div>
                            <!-- single-product end -->
                            <?php $__currentLoopData = $img; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="single-product">
                                    <div class="product-thumb">
                                        <img src="<?php echo e(asset('uploads/'.$item->image)); ?>" alt="product-thumb" />
                                    </div>
                                </div>
                                <!-- single-product end -->
                    ...
                    <div class="single-product-info">
                        ...
                        <div class="product-body mb-40">
                            <div class="d-flex align-items-center mb-30">
                                ...
                                <?php else: ?>
                                    <span class="product-price mr-20">
                                        <del class="del"><?php echo e($pro->price); ?> $</del>
                                        <span class="onsale"><?php echo e($pro->sale_price); ?> $</span>
                                    </span>
                                <?php endif; ?>
...
<?php echo $__env->make('front-end.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Desktop/DEVELOPMENT/myprojects/project_bkap/looki-1/resources/views/front-end/page/product-detail.blade.php ENDPATH**/ ?>