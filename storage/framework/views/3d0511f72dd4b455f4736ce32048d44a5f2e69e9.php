                        ...
                        <div class="row p-t-20">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <small class="form-control-feedback">Nhập tên thương hiệu sản phẩm</small> </div>
                            </div>
                        </div>
                        <!--/row-->
                        <div class="row p-t-20">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\bkap\looki\resources\views/admin/page/brand/add.blade.php ENDPATH**/ ?>