            ...
            <div class="tab-pane fade" id="dashboad" role="tabpanel">
              <div class="myaccount-content">
                ...
                <div class="welcome mb-20">
                  <p>
                    Hello, <strong><?php echo e(auth()->user()->display_name); ?></strong> (If Not
            ...
            >
              <div class="myaccount-content">
                ...
                <div class="account-details-form">
                    <div class="row">
                        <form action="<?php echo e(url('/updateAccount')); ?>" method="POST" enctype="multipart/form-data">
                          <?php echo csrf_field(); ?>
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <input type="file" id="input-file-now-custom-2" name="pro_pic" class="dropify" data-height="200" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                              <div class="col-12">
                                  <div class="card">
                                      <div class="card-body">
                                          <h4 class="card-title">Ngày sinh</h4>
                                          <input type="date" id="input-file-now-custom-2" name="birthday" value="<?php echo e(auth()->user()->birthday); ?>"/>
                                      </div>
                                  </div>
                              </div>
                          </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="statuss" name="gender" value="1" class="custom-control-input" <?php echo e((auth()->user()->gender) ? 'checked':''); ?>>
                                            <label class="custom-control-label" for="statuss">Nam</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="status" name="gender" value="0" class="custom-control-input" <?php echo e((auth()->user()->gender) ? '':'checked'); ?>>
                                            <label class="custom-control-label" for="status">Nữ</label>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                      ...
                      <?php if(Session::get('change_pass_success')): ?>
                        <div class="alert alert-success" role="alert">
                          <?php echo e(Session::get('change_pass_success')); ?>

                        </div>
                      <?php endif; ?>
                      <?php if(Session::get('change_pass_not_success')): ?>
                        <div class="alert alert-danger" role="alert">
                          <?php echo e(Session::get('change_pass_not_success')); ?>
...
<?php echo $__env->make('front-end.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\bkap\looki-1\resources\views/front-end/page/myaccount.blade.php ENDPATH**/ ?>