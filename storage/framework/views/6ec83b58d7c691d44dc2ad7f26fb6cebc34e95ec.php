...
<head>
    ...
    <link rel="icon" href="images/favicon/3.png" type="image/x-icon">
    <link rel="shortcut icon" href="images/favicon/3.png" type="image/x-icon">
...
<body class="theme-color-3">
                        ...
                        <div class="main-menu">
                            ...
                            <div class="absolute-logo">
                                <div class="brand-logo">
                                    <a href="#"><img alt="" src="images/icon/layout3/logo.png"></a>
                                </div>
                            </div>
                            <div class="">
                                        ...
                                        <div class="icon-nav d-none d-sm-block">
                                            <ul>
                                                <li class="onhover-div mobile-search">
                                                    <div><img alt="" src="images/icon/layout4/search.png"
                                                            onclick="openSearch()" class="img-fluid blur-up lazyload">
                                                        <i class="ti-search" onclick="openSearch()"></i>
                                                    </div>
                                                </li>
                                                <li class="onhover-div mobile-setting">
                                                    <div><img alt="" src="images/icon/layout4/setting.png"
                ...
                <div class="col-sm-12">
                    <div class="main-menu">
                        <div class="menu-left">
                            ...
                            <div class="brand-logo"><a href="index.html"><img
                                        src="images/icon/layout3/logo.png" class="img-fluid blur-up lazyload"
                                        alt=""></a></div>
                        </div>
                        <div class="menu-right pull-right">
                            <div>
                                            ...
                                            <ul class="mega-menu full-mega-menu">
                                                <li>
                                                    <div class="container">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            ...
                                                                            <li><a href="fashion-4.html">cyber
                                                                                    monday</a></li>
                                                                            <li><a href="marketplace-demo-3.html">new year</a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <img src="images/menu-banner.jpg"
                    ...
                    <div class="row footer-theme partition-f">
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="footer-contant">
                                <div class="footer-logo"><img src="images/icon/layout3/logo.png" alt=""></div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="modal-bg">
                                        ...
                                        <div class="offer-content"><img src="images/Offer-banner.png"
                        ...
                        <div class="setting-contant">
                            <div class="row demo-section">
                                <div class="col-md-4 col-6 text-center demo-effects">
                                    <div class="set-position">
                                        <a href="gradient.html" class="layout-container">
                                            <img src="images/landing-page/demo/gradient.jpg"
                                ...
                                <div class="col-md-4 col-6 text-center demo-effects">
                                    <div class="set-position">
                                        <a href="index.html" class="layout-container">
                                            <img src="images/landing-page/demo/fashion.jpg"
                                                class="img-fluid bg-img bg-top" alt="">
                                        </a>
                                ...
                                <div class="col-md-4 col-6 text-center demo-effects">
                                    <div class="set-position">
                                        <a href="fashion-2.html" class="layout-container">
                                            <img src="images/landing-page/demo/fashion-2.jpg"
                                                class="img-fluid bg-img bg-top" alt="">
                                        </a>
                                ...
                                <div class="col-md-4 col-6 text-center demo-effects">
                                    <div class="set-position">
                                        <a href="index.html" class="layout-container">
                                            <img src="images/landing-page/demo/fashion-3.jpg"
                                                class="img-fluid bg-img bg-top" alt="">
                                        </a>
    ...
    </html><?php /**PATH /Users/macbookpro/Desktop/DEVELOPMENT/env/tot-nghiep/resources/views/master.blade.php ENDPATH**/ ?>