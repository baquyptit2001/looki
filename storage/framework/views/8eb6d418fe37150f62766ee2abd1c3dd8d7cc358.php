                                  ...
                                  <div class="media flex-column">
                                      <div class="product-thumbnail position-relative">
                                          ...
                                          <a href="<?php echo e(route('product', $item->id)); ?>">
                                              <img
                                                  class="first-img"
                                                  src="<?php echo e(asset('uploads/'.$item->image)); ?>"
                                                  alt="thumbnail"
                                      ...
                                      <div class="media-body w-100">
                                          <div class="product-desc">
                                              ...
                                              >
                                                  ...
                                                  <?php else: ?>
                                                      <span class="product-price"><?php echo e($item->sale_price); ?> $</span>
                                                      <span><del><?php echo e($item->price); ?> $</del></span>
                                                  <?php endif; ?>
                                                  <div class="d-flex justify-content-end w-50">
                                                      <a href="<?php echo e(route('add-cart', $item->id)); ?>"
                                                          class="pro-btn"
                                                         >
...
<?php echo $__env->make('front-end.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Desktop/DEVELOPMENT/myprojects/project_bkap/looki-1/resources/views/front-end/page/home.blade.php ENDPATH**/ ?>