...
<head>
    ...
    <!-- chartist CSS -->
    <link href="<?php echo e(asset('admin/node_modules/morrisjs/morris.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('admin/dist/css/pages/ecommerce.css')); ?>" rel="stylesheet">
    <!-- Custom CSS -->
...
<body class="skin-default fixed-layout">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo e(asset('admin/images/logo-icon.png')); ?>" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="<?php echo e(asset('admin/images/logo-light-icon.png')); ?>" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src="<?php echo e(asset('admin/images/logo-text.png')); ?>" alt="homepage" class="dark-logo" />
                         <!-- Light Logo text -->
                         <img src="<?php echo e(asset('admin/images/logo-light-text.png')); ?>" class="light-logo" alt="homepage" /></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="<?php echo e(asset('admin/images/users/1.jpg')); ?>" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:30 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="<?php echo e(asset('admin/images/users/2.jpg')); ?>" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Sonu Nigam</h5> <span class="mail-desc">I've sung a song! See you at</span> <span class="time">9:10 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="<?php echo e(asset('admin/images/users/3.jpg')); ?>" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Arijit Sinh</h5> <span class="mail-desc">I am a singer!</span> <span class="time">9:08 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="<?php echo e(asset('admin/images/users/4.jpg')); ?>" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:02 AM</span> </div>
                                            </a>
                                        </div>
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="<?php echo e(asset('admin/images/big/img1.jpg')); ?>" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="<?php echo e(asset('admin/images/big/img2.jpg')); ?>" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="<?php echo e(asset('admin/images/big/img3.jpg')); ?>" alt="Third slide"></div>
                                                </div>
                                            </div>
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    <div class="user-pro-body">
                        <div><img src="<?php echo e(asset('admin/images/users/2.jpg')); ?>" alt="user-img" class="img-circle"></div>
                        <div class="dropdown">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Qlý danh mục <span class="badge badge-pill badge-cyan ml-auto">4</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(route('listCategory')); ?>">Danh sách </a></li>
                                <li><a href="<?php echo e(route('addCategory')); ?>">Thêm mới</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Qlý Sản phẩm <span class="badge badge-pill badge-cyan ml-auto">4</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(route('listProduct')); ?>">Danh sách </a></li>
                                <li><a href="<?php echo e(route('addProduct')); ?>">Thêm mới</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Qlý Tài khoản <span class="badge badge-pill badge-cyan ml-auto">4</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(route('listAccount')); ?>">Danh sách </a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Qlý Thương hiệu <span class="badge badge-pill badge-cyan ml-auto">4</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(route('listBrand')); ?>">Danh sách </a></li>
                                <li><a href="<?php echo e(route('addBrand')); ?>">Thêm mới</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Qlý Đơn Hàng <span class="badge badge-pill badge-cyan ml-auto">4</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(route('listOrder')); ?>">Danh sách </a></li>
                            </ul>
                        </li>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="<?php echo e(asset('admin/node_modules/jquery/jquery-3.2.1.min.js')); ?>"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="<?php echo e(asset('admin/node_modules/popper/popper.min.js')); ?>"></script>
    ...
    <!--stickey kit -->
    <script src="<?php echo e(asset('admin/node_modules/sticky-kit-master/dist/sticky-kit.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/node_modules/sparkline/jquery.sparkline.min.js')); ?>"></script>
    <!--Custom JavaScript -->
    ...
    <!-- ============================================================== -->
    <!--morris JavaScript -->
    <script src="<?php echo e(asset('admin/node_modules/raphael/raphael-min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/node_modules/morrisjs/morris.min.js')); ?>"></script>
    <!--Custom JavaScript -->
    <script src="<?php echo e(asset('admin/dist/js/ecom-dashboard.js')); ?>"></script>
...
<?php /**PATH C:\Users\ADMIN\Desktop\bkap\looki\resources\views/admin/layout/master.blade.php ENDPATH**/ ?>