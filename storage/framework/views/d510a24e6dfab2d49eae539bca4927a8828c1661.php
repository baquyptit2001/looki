                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php if($item->role==2): ?>
                                            <td>Admin</td>
                                        <?php else: ?>
                                            <td><?php echo e(($item->role)? "Mod" : "User"); ?></td>
                                        <?php endif; ?>
                                        ...
                                        <?php else: ?>    
                                            <?php if($item->role<2): ?>
                                                <td>
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if($item->role): ?>
                                                        <span class="label label-info"><a href="<?php echo e(route('roleUp', ['id'=>$item->id])); ?>" style="color: #fff">Gỡ mod</a></span> 
                                                    <?php else: ?>
                                                        <span class="label label-info"><a href="<?php echo e(route('roleUp', ['id'=>$item->id])); ?>" style="color: #fff">Nâng mod</a></span> 
                                                    <?php endif; ?>
                                                </td>
                                            <?php endif; ?>
                                        <?php endif; ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\bkap\looki\resources\views/admin/page/account/index.blade.php ENDPATH**/ ?>